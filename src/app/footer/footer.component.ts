...
export class FooterComponent implements OnInit {
  ...
  bueltatubotoiaAgertu() {
    ...
    this.agertuBueltatu = (url == '/productos' || url == '/grupos' || url == '/crear-ficha' || url =='/informes' || url == '/stock' || url == '/materiales'
      ...
      ||url == '/material-maileguak' ||url == '/produktu-mugimenduak' || url=='/langile' ||url == '/txandak'||url=='/editar-grupo' ||url=='/ordutegi'||url == '/kolore-historialak'||url == '/kolore-historialak-ezabatuta'
    );
  }
